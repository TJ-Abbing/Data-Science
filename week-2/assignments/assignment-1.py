...
# Check if user is within the invalid age range (younger than 18 or older than 70). If true (=invalid range), deny access.
if age < 18 or age > 70:
    ...
    if is_student and has_membership:
        ...
        # If true, check if user's age is an odd number. If true (=odd number), give user a free ticket.
        if age % 2 == 1:
            print("It's your lucky day! You've won a free ticket!")

        # If false (=even number), check if user is either a student or a member. If true, ticket price is €5.
        elif is_student or has_membership:
            print('Ticket price: €5')   

        # If false (=not a student and not a member), ticket price is €10.
        elif not is_student and not has_membership:
            print('Ticket price: €10')

# If user is older than 25, ticket price is €15.
elif age > 25:
